...
namespace Nop.Core.Domain.Catalog
{
    ...
    public class CatalogSettings : ISettings
    {
        ...
        /// </summary>
        public bool ShowProductCodeOnProductDetailsPage { get; set; }
        ...
        /// <summary>
        /// Gets or sets a value indicating whether to display destination part number of a product
        /// </summary>
        public bool ShowDestinationPartNumber { get; set; }
        ...
        /// <summary>
        /// An option indicating whether products on category and destination pages should include featured products as well
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the value indicating how many destinations to display in destinations block
        /// </summary>
        public int DestinationsBlockItemsToDisplay { get; set; }
        ...
        /// <summary>
        /// Gets or sets the default value to use for Destination page size options (for new destinations)
        /// </summary>
        public string DefaultDestinationPageSizeOptions { get; set; }
        /// <summary>
        /// Gets or sets the default value to use for Destination page size (for new destinations)
        /// </summary>
        public int DefaultDestinationPageSize { get; set; }
