...
namespace Nop.Core.Domain.Discounts
{
    ...
    public partial class Discount : BaseEntity
    {
        ...
        private ICollection<Destination> _appliedToDestinations;
        ...
        /// Gets or sets the categories
        /// </summary>
        public virtual ICollection<Destination> AppliedToDestinations
        {
            get { return _appliedToDestinations ?? (_appliedToDestinations = new List<Destination>()); }
            protected set { _appliedToDestinations = value; }
        }
        /// <summary>
