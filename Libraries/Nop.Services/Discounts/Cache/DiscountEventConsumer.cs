...
namespace Nop.Services.Discounts.Cache
{
        ...
        IConsumer<EntityDeleted<Destination>>
    {
        ...
        /// <summary>
        /// Key for destination IDs of a discount
        /// </summary>
        /// <remarks>
        /// {0} : discount id
        /// {1} : roles of the current user
        /// {2} : current store ID
        /// </remarks>
        public const string DISCOUNT_DESTINATION_IDS_MODEL_KEY = "Nop.discounts.destinationids-{0}-{1}-{2}";
        public const string DISCOUNT_DESTINATION_IDS_PATTERN_KEY = "Nop.discounts.destinationids";
        ...
        public void HandleEvent(EntityInserted<Discount> eventMessage)
        {
            ...
            _cacheManager.RemoveByPattern(DISCOUNT_DESTINATION_IDS_PATTERN_KEY);
        }
