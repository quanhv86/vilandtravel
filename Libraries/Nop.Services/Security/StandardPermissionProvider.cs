...
namespace Nop.Services.Security
{
    ...
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        public static readonly PermissionRecord ManageDestinations = new PermissionRecord { Name = "Admin area. Manage Destinations", SystemName = "ManageDestinations", Category = "Catalog" };
