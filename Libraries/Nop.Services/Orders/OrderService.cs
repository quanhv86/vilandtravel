...
namespace Nop.Services.Orders
{
    ...
    public partial class OrderService : IOrderService
    {
        ...
        /// Search orders
        /// </summary> 
        public virtual IPagedList<Order> SearchOrders(int storeId = 0,  int customerId = 0,
            int productId = 0, int affiliateId = 0, int billingCountryId = 0, string paymentMethodSystemName = null,
