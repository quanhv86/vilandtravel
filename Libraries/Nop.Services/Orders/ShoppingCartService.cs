...
namespace Nop.Services.Orders
{
    ...
    public partial class ShoppingCartService : IShoppingCartService
    {
            ...
            DateTime? departureDate = null, DateTime? rentalEndDate = null)
        {
            ...
            if (departureDate.Value.CompareTo(rentalEndDate.Value) > 0)
            {
            ...
            DateTime startDateUtc = _dateTimeHelper.ConvertToUtcTime(departureDate.Value, _dateTimeHelper.DefaultStoreTimeZone);
            //but we what if dates should be entered in a customer timezone?
            //DateTime startDateUtc = _dateTimeHelper.ConvertToUtcTime(departureDate.Value, _dateTimeHelper.CurrentTimeZone);
            ...
            bool getRentalWarnings = true)
        {
            ...
            if (getRentalWarnings)
                warnings.AddRange(GetRentalProductWarnings(product, departureDate, rentalEndDate));
            ...
            DateTime? rentalEndDate = null)
        {
            ...
            foreach (var sci in shoppingCart.Where(a => a.ShoppingCartType == shoppingCartType))
            {
                if (sci.ProductId == product.Id)
                {
                    ...
                    {
                        rentalInfoEqual = sci.DepartureDateUtc == departureDate && sci.RentalEndDateUtc == rentalEndDate;
                    }
            ...
            int quantity = 1, bool automaticallyAddRequiredProductsIfEnabled = true)
        {
            ...
            if (shoppingCartItem != null)
            {
                ...
                warnings.AddRange(GetShoppingCartItemWarnings(customer, shoppingCartType, product,
                    ...
                    customerEnteredPrice, departureDate, rentalEndDate,
            ...
            if (shoppingCartItem != null)
            {
                ...
                if (quantity > 0)
                {
                    ...
                    warnings.AddRange(GetShoppingCartItemWarnings(customer, shoppingCartItem.ShoppingCartType,
                        ...
                        departureDate, rentalEndDate, quantity, false));
                    if (!warnings.Any())
                    {
                        ...
                        shoppingCartItem.DepartureDateUtc = departureDate;
        ...
        public virtual void MigrateShoppingCart(Customer fromCustomer, Customer toCustomer, bool includeCouponCodes)
        {
            ...
            for (int i = 0; i < fromCart.Count; i++)
            {
                ...
                AddToCart(toCustomer, sci.Product, sci.ShoppingCartType, sci.StoreId, 
                    ...
                    sci.DepartureDateUtc, sci.RentalEndDateUtc, sci.Quantity, false);
            }
            for (int i = 0; i < fromCart.Count; i++)
            {
                var sci = fromCart[i];
