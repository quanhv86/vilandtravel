...
namespace Nop.Services.Orders
{
    ...
    public partial class OrderReportService : IOrderReportService
    {
        ...
        /// <param name="destinationId">Destination identifier; 0 to load all records</param>
        ...
        public virtual IPagedList<BestsellersReportLine> BestSellersReport(
            int categoryId = 0, int destinationId = 0,
            ...
            bool showHidden = false)
        {
            ...
            var query1 = from orderItem in _orderItemRepository.Table
                         ...
                         //join pm in _productDestinationRepository.Table on p.Id equals pm.ProductId into p_pm from pm in p_pm.DefaultIfEmpty()
                         ...
                         //(destinationId == 0 || pm.DestinationId == destinationId) &&
                         (categoryId == 0 || p.ProductCategories.Count(pc => pc.CategoryId == categoryId) > 0) &&
                         (destinationId == 0 || p.ProductDestinations.Count(pm => pm.DestinationId == destinationId) > 0) &&
