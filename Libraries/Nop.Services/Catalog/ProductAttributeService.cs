...
namespace Nop.Services.Catalog
{
    ...
    public partial class ProductAttributeService : IProductAttributeService
    {
        ...
        /// <summary>
        /// Gets a product attribute combination by product code
        /// </summary>
        /// <param name="code">Code</param>
        /// <returns>Product attribute combination</returns>
        public virtual ProductAttributeCombination GetProductAttributeCombinationByProductCode(string productCode)
        {
            ...
            var query = from pac in _productAttributeCombinationRepository.Table
                        orderby pac.Id
                        where pac.ProductCode == productCode
                        select pac;
