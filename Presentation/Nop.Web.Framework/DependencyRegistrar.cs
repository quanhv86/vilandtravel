...
namespace Nop.Web.Framework
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            builder.RegisterType<DestinationService>().As<IDestinationService>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<DestinationTemplateService>().As<IDestinationTemplateService>().InstancePerLifetimeScope();
