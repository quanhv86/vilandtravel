...
CREATE NONCLUSTERED INDEX [IX_Destination_DisplayOrder] ON [Destination] ([DisplayOrder] ASC)
GO
...
CREATE NONCLUSTERED INDEX [IX_PMM_Product_and_Destination] ON [Product_Destination_Mapping] ([DestinationId] ASC, [ProductId] ASC)
GO
...
CREATE NONCLUSTERED INDEX [IX_Destination_LimitedToStores] ON [Destination] ([LimitedToStores] ASC)
GO
...
CREATE NONCLUSTERED INDEX [IX_Destination_SubjectToAcl] ON [Destination] ([SubjectToAcl] ASC)
GO
