...
namespace Nop.Web.Infrastructure.Cache
{
    ...
    public partial class ModelCacheEventConsumer: 
        ...
        IConsumer<EntityInserted<DestinationTemplate>>,
        IConsumer<EntityUpdated<DestinationTemplate>>,
        IConsumer<EntityDeleted<DestinationTemplate>>,
        ...
        IConsumer<EntityUpdated<ShoppingCartItem>>
    {
        ...
        /// <summary>
        /// Key for DestinationNavigationModel caching
        /// </summary>
        /// <remarks>
        /// {0} : current destination id
        /// {1} : language id
        /// {2} : roles of the current user
        /// {3} : current store ID
        /// </remarks>
        public const string DESTINATION_NAVIGATION_MODEL_KEY = "Nop.pres.destination.navigation-{0}-{1}-{2}-{3}";
        public const string DESTINATION_NAVIGATION_PATTERN_KEY = "Nop.pres.destination.navigation";
        ...
        /// <summary>
        /// Key for caching of a value indicating whether a destination has featured products
        /// </summary>
        /// <remarks>
        /// {0} : destination id
        /// {1} : roles of the current user
        /// {2} : current store ID
        /// </remarks>
        public const string DESTINATION_HAS_FEATURED_PRODUCTS_KEY = "Nop.pres.destination.hasfeaturedproducts-{0}-{1}-{2}";
        public const string DESTINATION_HAS_FEATURED_PRODUCTS_PATTERN_KEY = "Nop.pres.destination.hasfeaturedproducts";
        public const string DESTINATION_HAS_FEATURED_PRODUCTS_PATTERN_KEY_BY_ID = "Nop.pres.destination.hasfeaturedproducts-{0}-";
        ...
        /// <summary>
        /// Key for ProductDestinations model caching
        /// </summary>
        /// <remarks>
        /// {0} : product id
        /// {1} : language id
        ...
        /// {3} : current store ID
        /// </remarks>
        public const string PRODUCT_DESTINATIONS_MODEL_KEY = "Nop.pres.product.destinations-{0}-{1}-{2}-{3}";
        public const string PRODUCT_DESTINATIONS_PATTERN_KEY = "Nop.pres.product.destinations";
        public const string PRODUCT_DESTINATIONS_PATTERN_KEY_BY_ID = "Nop.pres.product.destinations-{0}-";
        ...
        /// <summary>
        /// Key for DestinationTemplate caching
        /// </summary>
        /// <remarks>
        /// {0} : destination template id
        /// </remarks>
        public const string DESTINATION_TEMPLATE_MODEL_KEY = "Nop.pres.destinationtemplate-{0}";
        public const string DESTINATION_TEMPLATE_PATTERN_KEY = "Nop.pres.destinationtemplate";
        ...
        /// <summary>
        /// Key for destination picture caching
        /// </summary>
        /// <remarks>
        /// {0} : destination id
        /// {1} : picture size
        /// {2} : value indicating whether a default picture is displayed in case if no real picture exists
        /// {3} : language ID ("alt" and "title" can depend on localized destination name)
        /// {4} : is connection SSL secured?
        /// {5} : current store ID
        /// </remarks>
        public const string DESTINATION_PICTURE_MODEL_KEY = "Nop.pres.destination.picture-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string DESTINATION_PICTURE_PATTERN_KEY = "Nop.pres.destination.picture";
        public const string DESTINATION_PICTURE_PATTERN_KEY_BY_ID = "Nop.pres.destination.picture-{0}-";
        ...
        public void HandleEvent(EntityInserted<Language> eventMessage)
        {
            ...
            _cacheManager.RemoveByPattern(DESTINATION_NAVIGATION_PATTERN_KEY);
            ...
            _cacheManager.RemoveByPattern(PRODUCT_DESTINATIONS_PATTERN_KEY);
        ...
        public void HandleEvent(EntityUpdated<Setting> eventMessage)
        {
            ...
            _cacheManager.RemoveByPattern(DESTINATION_NAVIGATION_PATTERN_KEY); //depends on CatalogSettings.DestinationsBlockItemsToDisplay
        ...
        public void HandleEvent(EntityUpdated<Destination> eventMessage)
        {
            ...
            _cacheManager.RemoveByPattern(PRODUCT_DESTINATIONS_PATTERN_KEY);
            _cacheManager.RemoveByPattern(SITEMAP_PATTERN_KEY);
            _cacheManager.RemoveByPattern(string.Format(DESTINATION_PICTURE_PATTERN_KEY_BY_ID, eventMessage.Entity.Id));
        }
        ...
        {
            _cacheManager.RemoveByPattern(string.Format(PRODUCT_DESTINATIONS_PATTERN_KEY_BY_ID, eventMessage.Entity.ProductId));
            _cacheManager.RemoveByPattern(string.Format(DESTINATION_HAS_FEATURED_PRODUCTS_PATTERN_KEY_BY_ID, eventMessage.Entity.DestinationId));
        }
        ...
        public void HandleEvent(EntityInserted<DestinationTemplate> eventMessage)
        {
            _cacheManager.RemoveByPattern(DESTINATION_TEMPLATE_PATTERN_KEY);
        }
        public void HandleEvent(EntityUpdated<DestinationTemplate> eventMessage)
        {
            _cacheManager.RemoveByPattern(DESTINATION_TEMPLATE_PATTERN_KEY);
        }
        public void HandleEvent(EntityDeleted<DestinationTemplate> eventMessage)
        {
            _cacheManager.RemoveByPattern(DESTINATION_TEMPLATE_PATTERN_KEY);
        }
