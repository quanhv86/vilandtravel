    ...
    public partial class SettingController : BaseAdminController
	{
        ...
        public virtual ActionResult Catalog()
        {
            ...
            if (storeScope > 0)
            {
                ...
                model.ShowProductCodeOnProductDetailsPage_OverrideForStore = _settingService.SettingExists(catalogSettings, x => x.ShowProductCodeOnProductDetailsPage, storeScope);
                ...
                model.ShowDestinationPartNumber_OverrideForStore = _settingService.SettingExists(catalogSettings, x => x.ShowDestinationPartNumber, storeScope);
                ...
                model.DestinationsBlockItemsToDisplay_OverrideForStore = _settingService.SettingExists(catalogSettings, x => x.DestinationsBlockItemsToDisplay, storeScope);
        ...
        public virtual ActionResult Catalog(CatalogSettingsModel model)
        {
            ...
            _settingService.SaveSettingOverridablePerStore(catalogSettings, x => x.ShowProductCodeOnProductDetailsPage, model.ShowProductCodeOnProductDetailsPage_OverrideForStore, storeScope, false);
            ...
            _settingService.SaveSettingOverridablePerStore(catalogSettings, x => x.ShowDestinationPartNumber, model.ShowDestinationPartNumber_OverrideForStore, storeScope, false);
            ...
            _settingService.SaveSettingOverridablePerStore(catalogSettings, x => x.DestinationsBlockItemsToDisplay, model.DestinationsBlockItemsToDisplay_OverrideForStore, storeScope, false);
        ...
        public virtual ActionResult Media()
        {
            ...
            if (storeScope > 0)
            {
                ...
                model.DestinationThumbPictureSize_OverrideForStore = _settingService.SettingExists(mediaSettings, x => x.DestinationThumbPictureSize, storeScope);
        ...
        public virtual ActionResult Media(MediaSettingsModel model)
        {
            ...
            _settingService.SaveSettingOverridablePerStore(mediaSettings, x => x.DestinationThumbPictureSize, model.DestinationThumbPictureSize_OverrideForStore, storeScope, false);
        ...
        public virtual ActionResult GeneralCommon()
        {
            ...
            model.StoreInformationSettings.SitemapIncludeDestinations = commonSettings.SitemapIncludeDestinations;
            ...
            if (storeScope > 0)
            {
                ...
                model.StoreInformationSettings.SitemapIncludeDestinations_OverrideForStore = _settingService.SettingExists(commonSettings, x => x.SitemapIncludeDestinations, storeScope);
        ...
        public virtual ActionResult GeneralCommon(GeneralCommonSettingsModel model)
        {
            ...
            commonSettings.SitemapIncludeDestinations = model.StoreInformationSettings.SitemapIncludeDestinations;
            ...
            _settingService.SaveSettingOverridablePerStore(commonSettings, x => x.SitemapIncludeDestinations, model.StoreInformationSettings.SitemapIncludeDestinations_OverrideForStore, storeScope, false);
