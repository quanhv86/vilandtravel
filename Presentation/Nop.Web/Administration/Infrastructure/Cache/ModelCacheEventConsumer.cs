...
namespace Nop.Admin.Infrastructure.Cache
{
        ...
        IConsumer<EntityDeleted<Vendor>>
    {
        ...
        /// <summary>
        /// Key for destinations caching
        /// </summary>
        /// <remarks>
        /// {0} : show hidden records?
        /// </remarks>
        public const string DESTINATIONS_LIST_KEY = "Nop.pres.admin.destinations.list-{0}";
        public const string DESTINATIONS_LIST_PATTERN_KEY = "Nop.pres.admin.destinations.list";
        ...
        {
            _cacheManager.RemoveByPattern(DESTINATIONS_LIST_PATTERN_KEY);
        }
