        ...
        public Action<IMapperConfigurationExpression> GetConfiguration()
        {
            ...
            Action<IMapperConfigurationExpression> action = cfg =>
            {
                ...
                cfg.CreateMap<CategoryModel, Category>()
                    ...
                    .ForMember(dest => dest.LimitedToStores, mo => mo.Ignore());
                //destination
                cfg.CreateMap<Destination, DestinationModel>()
                    .ForMember(dest => dest.AvailableDestinationTemplates, mo => mo.Ignore())
                    .ForMember(dest => dest.Locales, mo => mo.Ignore())
                    .ForMember(dest => dest.AvailableDiscounts, mo => mo.Ignore())
                    .ForMember(dest => dest.SelectedDiscountIds, mo => mo.Ignore())
                    .ForMember(dest => dest.SeName, mo => mo.MapFrom(src => src.GetSeName(0, true, false)))
                    ...
                    .ForMember(dest => dest.SelectedStoreIds, mo => mo.Ignore())
                    .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
                cfg.CreateMap<DestinationModel, Destination>()
                    .ForMember(dest => dest.SubjectToAcl, mo => mo.Ignore())
                    .ForMember(dest => dest.CreatedOnUtc, mo => mo.Ignore())
                    .ForMember(dest => dest.UpdatedOnUtc, mo => mo.Ignore())
                    .ForMember(dest => dest.Deleted, mo => mo.Ignore())
                ...
                cfg.CreateMap<Product, ProductModel>()
                    ...
                    .ForMember(dest => dest.Locales, mo => mo.Ignore())
                    .ForMember(dest => dest.AvailableCategories, mo => mo.Ignore())
                    .ForMember(dest => dest.AvailableDestinations, mo => mo.Ignore())
                    ...
                    .ForMember(dest => dest.SelectedDestinationIds, mo => mo.Ignore())
                    .ForMember(dest => dest.SelectedDiscountIds, mo => mo.Ignore())
                ...
                cfg.CreateMap<ProductModel, Product>()
                    ...
                    .ForMember(dest => dest.ProductDestinations, mo => mo.Ignore())
                ...
                cfg.CreateMap<DiscountModel, Discount>()
                    ...
                    .ForMember(dest => dest.AppliedToDestinations, mo => mo.Ignore())
                ...
                cfg.CreateMap<CatalogSettings, CatalogSettingsModel>()
                    ...
                    .ForMember(dest => dest.DisplayDiscontinuedMessageForUnpublishedProducts_OverrideForStore,
                        mo => mo.Ignore())
                    .ForMember(dest => dest.ShowProductCodeOnProductDetailsPage_OverrideForStore, mo => mo.Ignore())
                    .ForMember(dest => dest.ShowSkuOnCatalogPages_OverrideForStore, mo => mo.Ignore())
                    .ForMember(dest => dest.ShowDestinationPartNumber_OverrideForStore, mo => mo.Ignore())
                    ...
                    .ForMember(dest => dest.DestinationsBlockItemsToDisplay_OverrideForStore, mo => mo.Ignore())
                ...
                cfg.CreateMap<CatalogSettingsModel, CatalogSettings>()
                    ...
                    .ForMember(dest => dest.DefaultDestinationPageSizeOptions, mo => mo.Ignore())
                    .ForMember(dest => dest.DefaultDestinationPageSize, mo => mo.Ignore())
                ...
                cfg.CreateMap<MediaSettings, MediaSettingsModel>()
                    ...
                    .ForMember(dest => dest.DestinationThumbPictureSize_OverrideForStore, mo => mo.Ignore())
                ...
                cfg.CreateMap<DestinationTemplate, DestinationTemplateModel>()
                    .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
                cfg.CreateMap<DestinationTemplateModel, DestinationTemplate>();
                //product template
