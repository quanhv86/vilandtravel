...
namespace Nop.Admin.Extensions
{
    public static class MappingExtensions
    {
        ...
        public static DestinationModel ToModel(this Destination entity)
        {
            return entity.MapTo<Destination, DestinationModel>();
        }
        ...
        public static DestinationTemplateModel ToModel(this DestinationTemplate entity)
        {
            return entity.MapTo<DestinationTemplate, DestinationTemplateModel>();
        }

        public static DestinationTemplate ToEntity(this DestinationTemplateModel model)
        {
            return model.MapTo<DestinationTemplateModel, DestinationTemplate>();
        }

        public static DestinationTemplate ToEntity(this DestinationTemplateModel model, DestinationTemplate destination)
        {
            return model.MapTo(destination);
        }
